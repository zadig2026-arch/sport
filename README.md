...
- **Programme** : 12 semaines, 3 séances fixes/semaine Push / Pull / Legs (7 exercices par séance, ~1h15-1h25), 2 phases (adaptation → progression). Chaque muscle reçoit sa grosse dose 1x/semaine. Dominante machines + compound maîtrisés (squat, bench, overhead press, dips, tractions). L'app propose automatiquement la séance suivante.
